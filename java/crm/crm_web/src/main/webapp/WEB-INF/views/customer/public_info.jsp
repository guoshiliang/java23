            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        ...
                        <button rel="${customer.id}" id="pullMyCustBtn" class="btn bg-maroon btn-sm"><i class="fa fa-recycle"></i>添加到我的客户</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">选择添加员工</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="tranBtnOk">添加</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<script>
    $(function () {
        ...
        //放入我的客户
        $("#pullMyCustBtn").click(function () {
            var id = $(this).attr("rel");
            layer.confirm("您确定要将该客户添加为自己的客户吗？",function () {
                window.location.href = "/customer/my/"+id+"/put/my";
            });
        });
       /* //放入公海
