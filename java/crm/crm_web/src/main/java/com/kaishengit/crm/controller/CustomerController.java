...
public class CustomerController extends BaseController{
    ...
    public String shareCustomerToPunlic(@PathVariable Integer id,HttpSession session,
        ...
        redirectAttributes.addFlashAttribute("message","成功将客户["+customer.getCustName()+"]放入我的");
        return "redirect:/customer/my";
    ...
    public String showPublicCustomerInfo(@PathVariable Integer id,Model model,HttpSession session) {
        Account account = getCurrUser(session);
     ...
     * 将公海客户放入我的客户
     */
    /*@GetMapping("/my/{id:\\d+}/put/my")
    public String putPunlicCustomerToMy(@PathVariable Integer id,HttpSession session,
                                        RedirectAttributes redirectAttributes){
        Account account =  getCurrUser(session);
        Customer customer = customerService.findById(id);
        if(customer == null){
        ...
        if(!customer.getAccountId().equals("")){
            throw new ForbiddenException();
        }
        customerService.putPunlicCustomerToMy(customer,account);
        redirectAttributes.addFlashAttribute("message","成功将公海客户["+customer.getCustName()+"]放入我的客户");
